...
! function (t, e) {
        ...
        xt = function () {
            ...
            return n.next = function () {
                ...
                if (!(t > this._items.length - 1 || t < 0))
                    if (this._isSliding) Q.one(this._element, Ot, (function () {
                        return e.to(t)
                    }));
                    else {
    ...
    var ei = "tooltip",
        ...
        mi = function () {
            ...
            return n.enable = function () {
                ...
                if (null !== t) return "object" == typeof e && m(e) ? (e.jquery && (e = e[0]), void(this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void(this.config.html ? (this.config.sanitize && (e = ti(e, this.config.whiteList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
            }, n.getTitle = function () {
    ...
    return Array.from || (Array.from = (Xo = Object.prototype.toString, Bo = function (t) {
