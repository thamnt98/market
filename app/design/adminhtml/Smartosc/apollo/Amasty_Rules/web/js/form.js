define([
    ...
    var amrulesForm = {
        update: function (type) {
            ...
            switch (action) {
                case 'ampromo_cart':
                    this.hideFields(['discount_qty', 'discount_step', 'amrulesrule[max_discount]'], type);
                    break;
                case 'groupn':
