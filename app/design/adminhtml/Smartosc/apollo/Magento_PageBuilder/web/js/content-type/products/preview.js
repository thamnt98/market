    ...
    var Preview =
        ...
        function (_preview2) {
            ...
            _proto.initSlider = function initSlider() {
                if (this.element && this.appearance() === "carousel") {
                    for (let item of this.element.children) {
                        (0, _jquery)(item.children).slick(this.buildSlickConfig());
                    }
                }
            }
            /**
            ...
            _proto.buildSlickConfig = function buildSlickConfig() {
                ...
                var transslidetoshow = parseFloat(attributes["data-carousel-products-display"]);
                var productCount = (0, _jquery)(this.widgetUnsanitizedHtml()).find(this.productItemSelector).length;
                var config = {
                    slidesToShow: transslidetoshow,
                    slidesToScroll: transslidetoshow,
                ...
                if (attributes["data-carousel-mode"] === "continuous" && productCount > transslidetoshow) {
