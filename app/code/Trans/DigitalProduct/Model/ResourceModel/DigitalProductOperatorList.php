 ...
 */
class DigitalProductOperatorList extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
	...
	protected function _construct() {
		$this->_init(DigitalProductOperatorListInterface::TABLE_NAME, DigitalProductOperatorListInterface::ID);
	}
