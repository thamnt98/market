 ...
 */
class DigitalProductTransactionResponse extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
	...
	protected function _construct() {
		$this->_init(DigitalProductTransactionResponseInterface::TABLE_NAME, DigitalProductTransactionResponseInterface::ID);
	}
