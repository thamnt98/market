 ...
 */
class DigitalProductInquireResponse extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
	...
	protected function _construct() {
		$this->_init(DigitalProductInquireResponseInterface::TABLE_NAME, DigitalProductInquireResponseInterface::ID);
	}
