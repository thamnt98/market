 ...
 */
namespace Trans\MepayTransmart\Console\Transaction\Status;

use Symfony\Component\Console\Command\Command;
use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;
use Symfony\Component\Console\Input\InputOption;
use Trans\MepayTransmart\Observer\Trans\IntegrationOrder\Model\OrderStatus as StatusModel;
...
class Check extends Command
{
     ...
     * @var string
     */
    const COMMAND_NAME = 'trans:mepay-order:status-check';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $result = $this->status->isPgCaptured($orderId);
