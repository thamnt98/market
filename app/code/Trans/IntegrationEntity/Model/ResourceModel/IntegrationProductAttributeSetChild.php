 ...
 * Class Reservation
 */
class IntegrationProductAttributeSetChild extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init(IntegrationProductAttributeSetChildInterface::TABLE_NAME, IntegrationProductAttributeSetChildInterface::ID);
    }
