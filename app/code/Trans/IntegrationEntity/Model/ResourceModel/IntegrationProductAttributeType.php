 ...
 * Class Reservation
 */
class IntegrationProductAttributeType extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init(IntegrationProductAttributeTypeInterface::TABLE_NAME, IntegrationProductAttributeTypeInterface::ID);
    }
