...
class Config extends \Magento\Framework\App\Helper\AbstractHelper {
	...
	public function getApiBaseUrl($paymentMethod) {
		...
		if ($channel === 'credit_card' || $paymentMethod == 'sprint_bcafullpayment_cc' || $paymentMethod == 'sprint_allbankfull_cc' || $paymentMethod == 'sprint_mega_cc' || $paymentMethod == 'sprint_allbank_debit') {
			switch ($this->isProduction()) {
			case true:
