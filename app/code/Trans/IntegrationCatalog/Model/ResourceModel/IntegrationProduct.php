 ...
 * Class Reservation
 */
class IntegrationProduct extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
	...
	protected function _construct() {
		$this->_init(IntegrationProductInterface::TABLE_NAME, IntegrationProductInterface::ID);
	}
