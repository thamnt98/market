...
class ProductAssociation {
    ...
    /**
     * @var ProductAssociationLogicInterface
     */
	...
	public function __construct(
		...
		,ProductAssociationLogicInterface $integrationProductLogicInterface
	...
	public function execute() {
		...
		try {
			...
			$response = $this->integrationProductLogicInterface->saveProductAssociation($data);
