...
use Trans\IntegrationCatalog\Cron\Pim\Save\ConfigurableProductImage as CronProductImage;
use Magento\Framework\App\State;

class ConfigurableProductImage extends Command
{
  /**
  ...
  protected function configure()
   {
       $this->setName('integration:pim-save:configurableproduct-synch-image');
       $this->setDescription('Synch and Save Configurable Product Image');
       parent::configure();
   }
