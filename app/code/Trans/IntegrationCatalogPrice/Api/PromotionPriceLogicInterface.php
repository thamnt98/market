...
interface PromotionPriceLogicInterface
{
    ...
    const PRODUCT_ATTR_SPECIAL_PRICE  = "special_price_";
    ...
    const IS_VISIBLE_IN_ADVANCED_SEARCH     = false;
    ...
    /**
     * Save Promotion Price test using controller
     * @param mixed $data
     * @return \Trans\IntegrationCatalogPrice\Api\Data\PromotionPriceInterface
     * @throws \Magento\Framework\Exception\LocalizedException
     */
