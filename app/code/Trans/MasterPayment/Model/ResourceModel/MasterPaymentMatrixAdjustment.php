 ...
 * Class MasterPayment
 */
class MasterPaymentMatrixAdjustment extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
	...
	protected function _construct() {
		$this->_init(MasterPaymentMatrixAdjustmentInterface::TABLE_NAME, MasterPaymentMatrixAdjustmentInterface::ID);
	}
