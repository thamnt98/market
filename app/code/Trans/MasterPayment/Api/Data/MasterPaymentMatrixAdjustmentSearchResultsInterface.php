 ...
 * @api
 */
interface MasterPaymentMatrixAdjustmentSearchResultsInterface extends SearchResultsInterface {
	/**
	 ...
	 *
	 * @param \Trans\MasterPayment\Api\Data\MasterPaymentMatrixAdjustmentInterface $items
	 * @return $this
	 */
