...
class CustomerMepayTokenAttribute implements DataPatchInterface, PatchRevertableInterface
{
   /**
    ...
    public function apply()
    {
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute('customer', 'trans_mepay_cc_token')->addData([
            'used_in_forms' => [
                'adminhtml_customer'
            ]
        ]);
    ...
    public function revert()
    {
        ...
        $customerSetup->removeAttribute(\Magento\Customer\Model\Customer::ENTITY, 'trans_mepay_cc_token');
