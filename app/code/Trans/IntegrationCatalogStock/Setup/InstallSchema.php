...
use \Trans\IntegrationCatalogStock\Api\Data\IntegrationProductInterface;
...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function integrationJobTable($setup)
    {
        ...
        $tableName = $setup->getTable(\Trans\IntegrationCatalogStock\Api\Data\IntegrationJobInterface::TABLE_NAME);
        ...
        if ($setup->getConnection()->isTableExists($tableName) != true) {
            ...
            $table = $setup->getConnection()
                ...
                ->addColumn(
                    ...
                    ucfirst(IntegrationJobInterface::HIT)
                )
                ->addColumn(
                    ...
                    ucfirst(IntegrationJobInterface::LAST_JB_ID)
                )
                ->addColumn(
    ...
    public function integrationDataValueTable($setup)
    {
        ...
        // Get tutorial_simplenews table
        $tableName = $setup->getTable(\Trans\IntegrationCatalogStock\Api\Data\IntegrationDataValueInterface::TABLE_NAME);
        // Check if the table already exists
        if ($setup->getConnection()->isTableExists($tableName) != true) {
            // Create tutorial_simplenews table
            $table = $setup->getConnection()
