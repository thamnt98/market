 ...
 */
namespace Trans\IntegrationCatalogStock\Model\ResourceModel;
 ...
 * Class Reservation
 */
class IntegrationJob extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init(IntegrationJobInterface::TABLE_NAME, IntegrationJobInterface::ID);
    }
