...
use SM\Customer\Api\TransCustomerRepositoryInterface as SmCustomerRepository;
...
class Social extends AbstractModel
{
    ...
    /**
     * @var SmCustomerRepository
     */
    protected $smCustomerRepository;
     ...
     * @param SmCustomerRepository $smCustomerRepository
    ...
    public function __construct(
        ...
        User $userModel,
        DateTime $dateTime,
        SmCustomerRepository $smCustomerRepository,
        ...
        $this->smCustomerRepository = $smCustomerRepository;
    ...
    public function createCustomerSocial($data, $store)
    {
        ...
        try {
            ...
            $this->smCustomerRepository->addIncompleteAddress($customer);
