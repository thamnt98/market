...
class Banner extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('sub_title', 'text', [
            'name'  => 'sub_title',
            'label' => __('Sub Title'),
            'title' => __('Sub Title'),
        ]);
        ...
        $fieldset->addField('promo_id', 'text', [
            'name'  => 'promo_id',
            'label' => __('Promotion ID'),
            'title' => __('Promotion ID'),
        ]);

        $fieldset->addField('promo_name', 'text', [
            'name'  => 'promo_name',
            'label' => __('Promotion Name'),
            'title' => __('Promotion Name'),
        ]);

        $fieldset->addField('promo_creative', 'text', [
            'name'  => 'promo_creative',
            'label' => __('Promotion Creative'),
            'title' => __('Promotion Creative'),
        ]);

        $fieldset->addField('promo_position', 'text', [
            'name'  => 'promo_position',
