...
define([
    ...
    $.widget('mage.addCategoryFilterList', {
        options          : {
            dialogUrl   : null,
            dialogButton: null,
            inputField  : null
        ...
        isGridLoaded     : false,
        registry         : null,
        massAssign       : 'filter_list_mass_assign',
        saveButtonName   : 'add_attributes_save_button',
         ...
         */
        updateGrid: function () {
            this.registry.get('smlayer_attribute_filter_listing.smlayer_attribute_filter_listing_data_source').reload({
                refresh: true
            });
        },
        ...
        onGridLoad: function () {
            ...
            this.registry.get(
                'smlayer_attribute_filter_listing.smlayer_attribute_filter_listing_data_source',
        ...
        _save: function () {
            let idColumn = this.registry
                .get('smlayer_attribute_filter_listing.smlayer_attribute_filter_listing.smlayer_attribute_filter_listing_columns.ids');
    ...
    return $.mage.addCategoryFilterList;
});
