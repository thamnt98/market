...
define([
    ...
    return Column.extend({
        ...
        setDefaultSelections: function () {
            var positionCacheValid = registry.get('filter_list_position_cache_valid'),
                selectedFromCache = registry.get('filter_list_selected_cache'),
                massAssign = registry.get('filter_list_mass_assign'),
                key,
                i;
            ...
            if (positionCacheValid && massAssign === true) {
                ...
                registry.set('filter_list_selected_cache', JSON.stringify(this.selected()));
                registry.set('filter_list_mass_assign', false);
            ...
            if (this.selectedData.length === 0) {
                ...
                registry.set('filter_list_position_cache_valid', true);
                registry.set('filter_list_selected_cache', JSON.stringify([]));
