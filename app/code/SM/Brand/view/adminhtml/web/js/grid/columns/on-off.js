...
define([
    ...
    return Column.extend({
        ...
        setDefaultSelections: function () {
            var positionCacheValid = registry.get('brand_list_position_cache_valid'),
                selectedFromCache = registry.get('brand_list_selected_cache'),
                massAssign = registry.get('brand_list_mass_assign'),
                key,
                i;
            ...
            if (positionCacheValid && massAssign === true) {
                ...
                registry.set('brand_list_selected_cache', JSON.stringify(this.selected()));
                registry.set('brand_list_mass_assign', false);
            ...
            if (this.selectedData.length === 0) {
                ...
                registry.set('brand_list_position_cache_valid', true);
                registry.set('brand_list_selected_cache', JSON.stringify([]));
