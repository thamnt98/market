...
define([
    ...
    'jquery/ui',
    'prototype',
    'SM_Brand/js/category/add-brand'
], function ($, mageTemplate, registry) {
    'use strict';

    $.widget('mage.SMBrand', {
        options       : {
            'gridSelector'         : '[data-grid-id=catalog_category_brand_list]',
            'addBrandContainer': '[data-role=catalog_category_add_brand_content]',
            'addBrandsUrl'         : null,
        ...
        _create: function () {
            ...
            $(this.options.addBrandContainer).addCategoryBrandList({
                dialogUrl   : this.options.addBrandsUrl,
                dialogButton: '[data-ui-id=category-form-assign-brand-add-brand-button]',
         ...
         * @param {mage.addCategoryBrandList} modal
         * @private
         */
