...
namespace SM\Promotion\Override\AmastyBannersLite\Model\SalesRule;
...
class SaveHandler implements ExtensionInterface
{
     ...
     * @param BannerRuleRepositoryInterface $bannerRuleRepository
     * @param BannerRuleFactory $bannerRuleFactory
    ...
    public function execute($entity, $arguments = [])
    {
        ...
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/nam.log');
