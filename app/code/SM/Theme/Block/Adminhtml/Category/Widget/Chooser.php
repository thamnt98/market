...
/**
 * Class Chooser
 * @package SM\Theme\Block\Adminhtml\Category\Widget
 * @author Son Nguyen <sonnn@smartosc.com>
 */

declare(strict_types=1);

namespace SM\Theme\Block\Adminhtml\Category\Widget;
...
class Chooser extends \Magento\Backend\Block\Template
{
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $data['after_element_js'] = $this->afterElementJs($element);
        $data['after_element_html'] = $this->afterElementHtml($element);
...
HTML;
     ...
     * @return string
     */
    protected function afterElementHtml($element)
    {
        $htmlId = $element->getId();
        $return = <<<HTML
...
HTML;
     ...
     * @return string
     */
    protected function afterElementJs($element)
    {
