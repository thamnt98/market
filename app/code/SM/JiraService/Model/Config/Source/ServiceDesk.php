...
class ServiceDesk implements OptionSourceInterface
{
    const URL_GET_SERVICE_DESK = '/rest/servicedeskapi/servicedesk';
    ...
    protected function getServiceDesk()
    {
        ...
        $requestUrl = $this->scopeConfig->getValue('sm_jira/ticket/domain') . self::URL_GET_SERVICE_DESK;
