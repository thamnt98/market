define(
    ...
    function ($) {
        ...
        $('.notification-search').on('click', '#btn-search-item', function () {
            var currentSort = '';
            var currentDate = '';
            var url = window.location.href;
            if($.fn.getValueParam('sort') !== null) {
            ...
            if($.fn.getValueParam('date') !== null) {
                currentDate = $.fn.getValueParam('date');
                url = $.fn.setValueParameter(url, 'date', currentDate);
            }
            var keyValue = $('#input-search').val();
            url = $.fn.setValueParameter(url, 'key', keyValue);
            window.location.href = url;
        ...
        $('.notification-sortby').on('click', '.radio-custom', function () {
            $('.notification-sortby .radio-custom input[name="sort"]').removeAttr('checked');
        ...
        $('.notification-filter-date').on('change', '#datepicker', function () {
            var currentSort = '';
            var currentKey = '';
            var url = window.location.href;
            if($.fn.getValueParam('sort') !== null) {
            ...
            url = $.fn.setValueParameter(url, 'date', dateValue);
            window.location.href = url;
        });
