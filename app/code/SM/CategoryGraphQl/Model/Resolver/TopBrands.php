 ...
 */
class TopBrands implements ResolverInterface
{
    const CONFIG_TOP_BRAND = 'trans_catalog/brand/top_brands';
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        $topBrandIds = $this->scopeConfig->getValue(self::CONFIG_TOP_BRAND);
        if (!$topBrandIds) {
            return [
                'total_count' => 0,
                'items' => []
