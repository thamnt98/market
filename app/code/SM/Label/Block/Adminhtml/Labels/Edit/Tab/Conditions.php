    ...
    protected function _prepareForm()
    {
        ...
        $fromDate = $fldDateRange->addField(
            ...
            [
                ...
                'class' => 'validate-date validate-date-range date-range-from_date-from',
                'required' => true,
                'note'      => __('From date has must less than to date.If not, label will not show.')
            ]
        );
        ...
        $toDate = $fldDateRange->addField('to_date', 'date', [
            ...
            'required' => true,
            'note'      => __("To date has must greater than from date. If not, label will not show.")
        ]);
