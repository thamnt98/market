...
namespace SM\Label\Controller\Adminhtml\Labels;

use Amasty\Label\Api\Data\LabelInterface;
use Magento\Framework\App\Filesystem\DirectoryList;
use Magento\Framework\Exception\LocalizedException;
use Magento\MediaStorage\Model\File\Uploader;
use Amasty\Label\Controller\Adminhtml\Labels\Save as SaveDefault;

/**
 * Class Save
 * @package SM\Label\Controller\Adminhtml\Labels
 */
class Save extends SaveDefault
{
    ...
    private function validateLabelData($data)
    {
        ...
        //custom fixed position default value is bottom left
        if (!isset($data['prod_pos'])) {
            $data['prod_pos'] = self::POSITION_BOTTOM_LEFT;
        }

        if (!isset($data['cat_pos'])) {
            $data['cat_pos'] = self::POSITION_BOTTOM_LEFT;
        }
