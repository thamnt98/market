...
use \SM\DigitalProduct\Api\Processor\ElectricityPrepaidProcessorInterface;

class ElectricityToken extends AbstractInquire implements ElectricityPrepaidProcessorInterface
{
    /**
     * @inheritDoc
     */
