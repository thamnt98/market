...
/**
 * Class CreateTopicConfigRelatedProductsBlock
 * @package SM\InspireMe\Setup\Patch\Data
 */
class CreateArticleConfigRelatedProductsBlock implements DataPatchInterface
{
    /**
    ...
    private function getAttributes()
    {
        return [
            'related_products_title' => [
                'type' => 'varchar',
                'label' => 'Related Products Block Title',
                'input' => 'text',
                'required' => false,
            ],
        ];
