...
return [
    ...
    'modules' => [
        ...
        'Metro_CronCategory' => 1,
        'Metro_CronConfigurable' => 1,
        'Metro_CronImage' => 1,
        'Metro_CronPrice' => 1,
        'Metro_CronProduct' => 1,
        'Metro_CronPromo' => 1,
        ...
        'Trans_Sprint' => 1,
        'SM_Checkout' => 1,
        'SM_InventoryBundleProductIndexer' => 1,
        'SM_Help' => 1,
        'SM_Label' => 1,
        ...
        'SM_Reports' => 1,
        'SM_Review' => 1,
        'SM_FreshProductApi' => 1,
        'SM_Search' => 1,
        'SM_AndromedaSms' => 1,
        'SM_ShoppingList' => 1,
        'Trans_IntegrationOrder' => 1,
        'SM_StoreviewFlags' => 1,
        'SM_TobaccoAlcoholProduct' => 1,
        'SM_Theme' => 1,
        'SM_TodayDeal' => 1,
        'SM_UpdateColorAttributeType' => 1,
        'Ves_Megamenu' => 1,
        'SM_ViewLog' => 1,
        'Temando_ShippingRemover' => 1,
        'Trans_AllowLocation' => 1,
        'Trans_Brand' => 1,
        'Trans_Core' => 1,
        'Trans_Customer' => 1,
        'Trans_CustomerMyProfile' => 1,
        'SM_Installation' => 1,
        'Trans_Integration' => 1,
        'Trans_IntegrationBrand' => 1,
        'Trans_IntegrationCatalog' => 1,
        'Trans_IntegrationCatalogPrice' => 1,
        'Trans_IntegrationCatalogStock' => 1,
        'Trans_IntegrationCategory' => 1,
        'Trans_IntegrationCustomer' => 1,
        'Trans_IntegrationEntity' => 1,
        'Trans_IntegrationLogistic' => 1,
        'Trans_IntegrationNotification' => 1,
        'SM_JiraService' => 1,
